...
public class EarthquakeAdapter extends ArrayAdapter<Event> {
    ...
    public EarthquakeAdapter(Context context, List<Event> earthquake) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        magnitude.setText(formatter.format(data.magnitude));
        GradientDrawable magnitudeCircle = (GradientDrawable) magnitude.getBackground();
        int magnitudeColor = getMagnitudeColor(data.magnitude);
        ...
        Date dateObject = new Date(data.time);
